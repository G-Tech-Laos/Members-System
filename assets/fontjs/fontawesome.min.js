! function () {
  ...
  var c = (e.navigator || {}).userAgent,
    ...
    Y = ["xs", "sm", "lg", "fw", "ul", "li", "border", "pull-left", "pull-right", "spin", "pulse", "rotate-90", "rotate-180", "rotate-270", "flip-horizontal", "flip-vertical", "flip-both", "stack", "stack-1x", "stack-2x", "inverse", "layers", "layers-text", "layers-counter", H.GROUP, H.SWAP_OPACITY, H.PRIMARY, H.SECONDARY].concat(_.map(function (t) {
      return "".concat(t, "x")
  ...
  St.prototype = {
    ...
    return e && "object" === r(e) && e.constructor === St ? e : new St(function (t) {
      t(e)
    })
  ...
  function Ht(t) {
    ...
    var b, y, w, x, k, S, A, C, M, O, P, N, E, z, L, j, R, T, _, F, I, H, Y, D, U, q, V = G({}, v, {
        prefix: r,
        iconName: i,
        main: n,
        mask: a,
      ...
      W = a.found && n.found ? (w = (b = V).children, x = b.attributes, k = b.main, S = b.mask, A = b.transform, C = k.width, M = k.icon, O = S.width, P = S.icon, N = _t({
        transform: A,
        containerWidth: O,
        iconWidth: C
      }), E = {
        ...
        children: M.children.map(It)
      } : {}, L = {
        tag: "g",
        attributes: G({}, N.inner),
        children: [It(G({
          tag: M.tag,
          attributes: G({}, M.attributes, N.path)
        }, z))]
      }, j = {
        tag: "g",
        attributes: G({}, N.outer),
        children: [L]
      }, R = "mask-".concat(Nt()), T = "clip-".concat(Nt()), _ = {
        tag: "mask",
        attributes: G({}, Ft, {
          id: R,
  ...
  function Yt(t) {
    ...
    Tt(r) && (y.transform = (u = (l = {
      ...
      width: n,
      height: a
    }).transform, d = l.width, m = void 0 === d ? S : d, h = l.height, p = void 0 === h ? S : h, g = l.startCentered, b = "", b += (v = void 0 !== g && g) && k ? "translate(".concat(u.x / Ct - m / 2, "em, ").concat(u.y / Ct - p / 2, "em) ") : v ? "translate(calc(-50% + ".concat(u.x / Ct, "em), calc(-50% + ").concat(u.y / Ct, "em)) ") : "translate(".concat(u.x / Ct, "em, ").concat(u.y / Ct, "em) "), b += "scale(".concat(u.size / Ct * (u.flipX ? -1 : 1), ", ").concat(u.size / Ct * (u.flipY ? -1 : 1), ") "), b += "rotate(".concat(u.rotate, "deg) ")), y["-webkit-transform"] = y.transform);
    var w = Rt(y);
  ...
  var ie = {};
  var oe = function (i, o) {
      var t = (2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : {}).url,
        c = void 0 === t ? Q.fetchSvgFrom : t;
      return ie[i] && ie[i][o] || (ie[i] = G({}, ie[i] || {}, l({}, o, []))), new At(function (e, t) {
        ...
        if (ie[i][o].push(function (t) {
          ...
          if ("function" == typeof fetch) fetch(a).then(function (t) {
            return t.text()
          }).then(function (t) {
            re(i, o, t)
          }).catch(function () {
  ...
  function Re(r, i) {
    return new At(function (n, t) {
      ...
      if (r && i && Q.autoFetchSvg) return oe(i, r).then(function (t) {
        var e = {};
        t && (e = je(t)), n(G({}, a, e))
      }).catch(t);
      r && i && !Q.showMissingIcons ? t(new Me("Icon is missing for prefix ".concat(i, " with icon name ").concat(r))) : n(a)
    })
  }
  var Te = $.styles;
  ...
  function _e(t) {
    ...
    return ~a.extra.classes.indexOf(j) ? function (t, e) {
      ...
      return Q.autoA11y && !n && (r.attributes["aria-hidden"] = "true"), At.resolve([t, Yt({
        content: t.innerHTML,
        width: i,
        height: o,
        transform: a,
    ...
    }(t, a) : (i = t, o = (e = a).iconName, c = e.title, s = e.prefix, f = e.transform, l = e.symbol, n = e.mask, u = e.extra, new At(function (r, t) {
      At.all([Re(o, s), Re(n.iconName, n.prefix)]).then(function (t) {
        var e = d(t, 2),
          n = e[0],
          a = e[1];
        r([i, Ht({
    ...
    return new At(function (a, t) {
      ...
      if (r) {
        var o = n.getPropertyValue("content"),
          c = ~["Solid", "Regular", "Light", "Duotone", "Brands"].indexOf(r[1]) ? L[r[1].toLowerCase()] : T[i],
          s = Bt(3 === o.length ? o.substr(1, 1) : o),
          f = se(c, s),
          l = f;
        if (l || (l = s), f || (f = String.fromCharCode(parseInt(s, 16))), !f || e && e.getAttribute(C) === c && e.getAttribute(M) === l) a();
        else {
